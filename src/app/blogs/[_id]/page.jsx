...
// import { FaCalendarAlt, FaClock, FaEye, FaHeart, FaComment } from 'react-icons/fa';
...
//                     <h3 className="text-xl font-semibold mb-4 text-gray-800">AI-Powered Features Used</h3>
...
//                                 <p className="text-gray-600 mt-1">{feature.details}</p>
//                             </div>
//                         ))}
//                     </div>
//                 </div>
...
//                 </div>
//                 <div className="flex items-center text-gray-700">
//                     <FaHeart className="text-xl mr-2 text-red-500" />
//                     <span>{blog.stats.likes} likes</span>
//                 </div>
//                 <div className="flex items-center text-gray-700">
//                     <FaComment className="text-xl mr-2 text-blue-500" />
